...
ARG KESTRA_PLUGINS="io.kestra.plugin:plugin-script-shell:LATEST io.kestra.plugin:plugin-script-python:LATEST io.kestra.plugin:plugin-docker:LATEST io.kestra.plugin:plugin-git:LATEST"
ARG APT_PACKAGES=""
